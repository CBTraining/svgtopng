...
import { CodeBracketSquareIcon, ClipboardDocumentIcon, CheckIcon as Check } from '@heroicons/react/24/solid';
      ...
      <div className="editor-layout" style={{ display: 'grid', gridTemplateColumns: '1fr 350px', gap: '2rem', alignItems: 'start' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
          <div className="checkerboard-bg" style={{ 
            ...
            <style>{cssCode}</style>
            <div className="glow-card" dangerouslySetInnerHTML={{ __html: '<!-- Content goes here -->' }} />
          </div>
          ...
          <div className="glass-panel" style={{ padding: '1.5rem', position: 'relative' }}>
            <button 
              ...
              style={{ position: 'absolute', top: '1rem', right: '1rem', display: 'flex', alignItems: 'center', gap: '0.5rem', padding: '0.5rem 1rem' }}
            >
